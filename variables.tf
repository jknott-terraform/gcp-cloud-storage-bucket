...
variable "bucketname" {
  ...
  default = "my-bucket-name-testing-with-kms-key-04082019"
}
...
variable "kms_key_name" {
  ...
  default     = "projects/terraform-development-testing/locations/global/keyRings/terraform-key-ring/cryptoKeys/terraform-testing-key"
}
